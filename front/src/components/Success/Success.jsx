...
const Success = () => {
  return (
    <div>
        <div className="modalcardsuccess">
          <div className="overlaycardsuccess"></div>
          <div className="modal-content-card-success">
            <div class="success">
                <div className="successcontainer">
                    ...
                    <div class="success__title">Report Added Successfully!</div>
